<div>
    ...
    <x-dialog-modal wire:model="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-button class="mr-3" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-button>
        </x-slot>
    </x-dialog-modal>
    ...
    <x-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-danger-button class="mr-3" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </x-danger-button>
        </x-slot>
