<x-master>
    <form action="{{ route('usefulLink.store') }}" method="post" class=" m-10">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="url" name="link" id="link" autocomplete="link" required class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('link')
                <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
