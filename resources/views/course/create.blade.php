<x-master>
    <form action="{{ route('course.store') }}" method="post" class=" m-10">
        @csrf


        <div class="col-span-6 sm:col-span-4">
            <label for="code" class="mt-4 block font-medium text-sm text-gray-700">{{ __('Code') }}</label>
            <input type="text" name="code" id="code" autocomplete="code" required class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('code')
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="text" name="name" id="name" autocomplete="name" required class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('name')
                <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="text" name="description" id="description" autocomplete="description" required class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('description')
                <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
