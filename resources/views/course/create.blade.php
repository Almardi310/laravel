<x-master>
    <form action="{{ route('course.store') }}" method="post" class=" m-10">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="text" name="code" id="code" autocomplete="code" class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('code')
