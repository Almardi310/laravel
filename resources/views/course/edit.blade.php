<x-master>
    <form action="{{ route('course.update', $myCourse) }}" method="post" class=" m-10">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="text" name="code" id="code" autocomplete="code" required value="{{ $myCourse->code }}" class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('code')
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="text" name="name" id="name" autocomplete="name" required value="{{ $myCourse->name }}" class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('name')
                <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <input type="text" name="description" id="description" autocomplete="description" required value="{{ $myCourse->description }}" class="mt-2 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" >
            @error('description')
                <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
            @enderror
        </div>
